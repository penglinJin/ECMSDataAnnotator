<template>
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="80px">
      ...
      <el-form-item label="comfirmPassword" prop="comfirmPassword" :class="{ 'is-required': !dataForm.id }">
        <el-input v-model="dataForm.comfirmPassword" type="password" placeholder="comfirmPassword"></el-input>
      </el-form-item>
      ...
      <el-form-item label="status" size="mini" prop="status">
        <el-radio-group v-model="dataForm.status">
          <el-radio :label="0">forbid</el-radio>
